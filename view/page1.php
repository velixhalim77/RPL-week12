...
<div class="container">
	<div class="row mt-3">
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">Details Movie</div>
					<div class="card-body">
				...
				<div class="row">
					...
					<div class="col-md-6">
						<img src="#" alt="Link Poster not found !" width="300" height="400">
					</div>
...
<nav class="navbar fixed-bottom navbar-dark bg-dark center">
        <a class="navbar-brand" href="#">RPL - Week12 - Education</a>
    </nav>
